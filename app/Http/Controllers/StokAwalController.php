...
class StokAwalController extends Controller
{
    ...
    public function index()
    {
        ...
        $user = Auth::user();
        $check = $this->checkAccess('stokAwal.index', $user->id, $user->idRole);
        if ($check) {
    ...
    public function create()
    {
        ...
        $user = Auth::user();
        $check = $this->checkAccess('stokAwal.create', $user->id, $user->idRole);
        if ($check) {
    ...
    public function store(Request $request)
    {
        ...
        $idStokAwal = DB::table('StokAwal')->insertGetId(
            array(
