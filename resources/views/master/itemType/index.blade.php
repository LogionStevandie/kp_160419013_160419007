            ...
            <div class="col-md-8 offset-md-2">
                <form action="/itemTypee/searchname/" method="get">
                    <div class="input-group">
                        <input type="text" class="form-control form-control-lg" name="searchname" placeholder="Nama Tipe Item">
                               ...
                               <tr>
                                ...
                                <td>  
                                    ...
                                    <div class="modal fade" id="detail_{{$tag->ItemTypeID}}">
                                     ...
                                     <button type="button" class="btn btn-default bg-danger" data-toggle="modal" data-target="#delete_{{$tag->ItemTypeID}}">
                                     <i class="fas fa-trash"></i> 
                                    </button>

                                     <div class="modal fade" id="delete_{{$tag->ItemTypeID}}">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
