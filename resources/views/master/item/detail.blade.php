        ...
        <form action="{{route('item.update',[$item->ItemID])}}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input require type="text" name="nameItem" class="form-control" value="{{old('nameItem',$item->ItemName)}}" disabled>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input require type="text" name="note" class="form-control" value="{{old('note',$item->Notes)}}" disabled>
                </div>
