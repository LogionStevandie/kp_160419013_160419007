        ...
        <form action="{{route('item.update',[$item->ItemID])}}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input require type="text" name="nameItem" class="form-control" value="{{old('nameItem',$item->ItemName)}}" maxlength="200">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input require type="text" name="note" class="form-control" value="{{old('note',$item->Notes)}}" maxlength="256">
                </div>
                ...
                <div class="form-group ">
                    ...
                    <div class="form-check form-check-inline">
                        <input checked class="form-check-input" type="radio" name="CanBeSell" value="0" {{'0'== old('CanBeSell',$item->CanBeSell)? 'checked' :'' }}>
                        <label class="form-check-label" for="inlineRadio2">Tidak</label>
                    </div><br>
                </div>
