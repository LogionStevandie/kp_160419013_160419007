        ...
        <form action="{{route('item.store')}}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input require type="text" name="nameItem" class="form-control" value="{{old('nameItem','')}}" maxlength="200">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input require type="text" name="note" class="form-control" value="{{old('note','')}}" maxlength="256">
                </div>
