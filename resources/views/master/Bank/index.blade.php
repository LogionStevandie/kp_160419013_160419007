                        ...
                        <tbody>
                           ...
                           <tr>
                                ...
                                <td>  
                                    ...
                                    <button type="button" class="btn btn-default bg-danger" data-toggle="modal" data-target="#delete_{{$bank->id}}">
                                     <i class="fas fa-trash"></i> 
                                    </button>

                                     <div class="modal fade" id="delete_{{$bank->id}}">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                     Apakah anda yakin mau menghapus "{{$bank->name}}"
                                                </div>
