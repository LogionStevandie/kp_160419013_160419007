...
@section('judul')
Detail Nota Kirim Barang Pesanan
@endsection
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select disabled readonly class="form-control selectpicker" data-live-search="true" data-show-subtext="true" style="width: 100%;" id="idGudang" name="MGudangIDAwal">
                                                    <option value="">
                                                        --Pilih Gudang Awal--
                                                    </option>
