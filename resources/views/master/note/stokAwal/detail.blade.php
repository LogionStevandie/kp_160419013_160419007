        ...
        <form action="{{route('stokAwal.show')}}" method="POST">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input disabled type="text" name="name" maxlength="255" class="form-control" value="{{old('name',$stokAwal->name)}}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input required type="number" step=".01" min="1" name="jumlah" class="form-control" value="{{old('jumlah',$stokAwal->jumlah)}}" disabled>
                </div>

                <div class="form-group">
                    <label for="title">Keterangan</label>
                    <input required type="text" name="keterangan" maxlength="500" class="form-control" value="{{old('keterangan',$stokAwal->keterangan)}}" disabled>
                </div>
