                                ...
                                <div class="py-5 ">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input disabled name="tanggalDibuat" type="date" class="form-control" id="lastName" placeholder="" value="{{$suratJalan->tanggalDibuat}}" required="">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select disabled class="form-control selectpicker" data-live-search="true" data-show-subtext="true" style="width: 100%;" id="idGudang" name="MGudangIDAwal">
                                                    <option value="">
                                                        --Pilih Gudang Awal--
                                                    </option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select disabled class="form-control selectpicker" data-live-search="true" data-show-subtext="true" style="width: 100%;" id="idGudangTujuan" name="MGudangIDTujuan">
                                                    <option value="">
                                                        --Pilih Gudang Tujuan--
                                                    </option>
                                                    @foreach($dataGudang as $key => $data)
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <textarea disabled rows="3" type="text" name="keteranganKendaraan" class="form-control" value="{{old('keteranganKendaraan',$suratJalan->keteranganKendaraan)}}">{{$suratJalan->keteranganKendaraan}}</textarea>
                                        </div>

                                        <div class="col-md-6 mb-3">
                                            <label for="lastName">Keterangan Nomor Polisi</label>
                                            <textarea disabled rows="3" type="text" name="keteranganNomorPolisi" class="form-control" value="{{old('keteranganNomorPolisi',$suratJalan->keteranganNomorPolisi)}}">{{$suratJalan->keteranganNomorPolisi}}</textarea>
                                        </div>

                                        <div class="col-md-6 mb-3">
                                            <label for="lastName">Keterangan Pengemudi</label>
                                            <textarea disabled rows="3" type="text" name="keteranganPemudi" class="form-control" value="{{old('keteranganPemudi',$suratJalan->keteranganPemudi)}}">{{$suratJalan->keteranganPemudi}}</textarea>
                                        </div>

                                        <div class="col-md-6 mb-3">
                                            <label for="lastName">Keterangan Transaksi</label>
                                            <textarea disabled rows="3" type="text" name="keteranganTransaksi" class="form-control" value="{{old('keteranganTransaksi',$suratJalan->keteranganTransaksi)}}">{{$suratJalan->keteranganTransaksi}}</textarea>
                                        </div>

                                        <div class="col-md-6 mb-3">
                                            <label for="lastName">Keterangan Gudang Tujuan</label>
                                            <textarea disabled rows="3" type="text" name="keteranganGudangTujuan" class="form-control" value="{{old('keteranganGudangTujuan',$suratJalan->keteranganGudangTujuan)}}">{{$suratJalan->keteranganGudangTujuan}}</textarea>
                                        </div>

                                        <div class="col-md-6 mb-3">
                                            <label for="lastName">Keterangan Penerima</label>
                                            <textarea disabled rows="3" type="text" name="keteranganPenerima" class="form-control" value="{{old('keteranganPenerima',$suratJalan->keteranganPenerima)}}">{{$suratJalan->keteranganPenerima}}</textarea>
                                        </div>
