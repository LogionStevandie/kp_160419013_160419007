        ...
        <div class="card-body">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                value="{{old('jumlah',$adjustmentStock->Description)}}" maxlength="500" >
            </div>
            ...
            <div class="form-group">
                ...
                value="{{old('QuantityAwal',$adjustmentStockDetail[0]->QuantityAwal)}}">
            </div>
            ...
            <div class="form-group">
                ...
                value="{{old('QuantityBaru',$adjustmentStockDetail[0]->QuantityBaru)}}" >
            </div>
