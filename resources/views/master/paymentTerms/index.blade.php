                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>  
                                    ...
                                    <form action="{{route('paymentTerms.destroy',[$d->PaymentTermsID])}}" method="POST" class="btn btn-responsive">
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn btn-default bg-danger" action="{{route('paymentTerms.destroy',[$d->PaymentTermsID])}}">
