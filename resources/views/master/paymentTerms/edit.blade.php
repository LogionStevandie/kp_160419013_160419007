        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <div class="icheck-primary d-inline">
                    <input type="radio" id="radioPrimary1" name="pembelian" checked value="1"{{'1' == old('pembelian','')? 'checked' :'' }}>
                    <label for="radioPrimary1">Pembelian
                    </label>
                </div>
                <div class="icheck-primary d-inline">
                    <input type="radio" id="radioPrimary2" name="pembelian" value="0"{{'0' == old('pembelian','')? 'checked' :'' }}>
