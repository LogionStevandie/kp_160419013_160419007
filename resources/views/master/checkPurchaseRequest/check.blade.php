...
<li class="breadcrumb-item"><a href="{{route('checkPurchaseRequest.index')}}">Permintaan Pembelian</a></li>
...
<div class="container-fluid">
    ...
    <div class="card card-primary">
        <!-- form start -->
        <form method="POST" action="{{route('checkPurchaseRequest.update',[$purchaseRequest->id])}}" >
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div id="ket">
                                    ...
                                    <textarea rows="3" required type="text" name="keterangan"class="form-control" value="{{old('keteranganProses','')}}" id="txt"></textarea>
                                </div>
                            </div>    
