...
<div class="card card-primary">
    ...
    <form action="{{route('mCurrency.update',[$mCurrency->MCurrencyID])}}" method="POST" >
        @csrf
        @method('PUT')
        <div class="card-body">
