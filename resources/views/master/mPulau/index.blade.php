            ...
            <div class="col-md-8 offset-md-2">
                <form action="/mPulaue/searchname/" method="get">
                    <div class="input-group">
                        <input type="text" class="form-control form-control-lg" name="searchname" placeholder="Nama Pulau">
                            ...
                            @foreach($data as $d)
                             <tr>
                                ...
                                <td>  
                                    ...
                                    <button type="button" class="btn btn-default bg-danger" data-toggle="modal" data-target="#delete_{{$d->MPulauID}}">
                                     <i class="fas fa-trash"></i> 
                                    </button>

                                     <div class="modal fade" id="delete_{{$d->MPulauID}}">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
