...
@section('judul')
Detail Nota Permintaan Pembelian
@endsection
                ...
                <div class="py-5 ">
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-4">
                      ...
                      <input disabled type="text" class="form-control" id="firstName" placeholder="" value="{{old('name',$purchaseRequest->name)}}" readonly required="" name="name">
                      <div class="invalid-feedback"> Valid first name is required. </div>
                    </div>
                    <div class="col-md-6 mb-3">
                      <label for="lastName">Tanggal Pembuatan</label>
                      <input disabled type="date" class="form-control" id="tanggalDibuat" placeholder="" value="{{old('created_on',$purchaseRequest->tanggalDibuat)}}" required="" name="tanggalDibuat">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <div class="input-group">
                        ...
                        <input disabled type="text" name="tanggalDibutuhkan" class="form-control float-right" id="reservation" value="{{date('d/F/Y', strtotime($purchaseRequest->tanggalDibutuhkan))}} - {{date('d/F/Y', strtotime($purchaseRequest->tanggalAkhirDibutuhkan))}}">
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select disabled class="form-control selectpicker" data-live-search="true" data-show-subtext="true" style="width: 100%;" name="gudang" id="gudang">
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <select disabled class="form-control selectpicker" data-live-search="true" data-show-subtext="true" style="width: 100%;" name="jenisProses">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="card card-danger">
                        ...
                        <div class="card-body">
                          ...
                          <div class="form-group">
                            <label>Barang</label>
                            <select disabled class="form-control selectpicker" id="barang" data-live-search="true" data-show-subtext="true">
