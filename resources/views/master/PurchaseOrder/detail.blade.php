                  ...
                  <div class="py-5 ">
                        ...
                        <div class="row">
                              <div class="col-md-12 mb-4">
                                  ...
                                  <input type="text" class="form-control" id="firstName" placeholder="" value="{{old('name',$purchaseOrder->name)}}" readonly required="" disabled>
                                  <div class="invalid-feedback"> Valid first name is required. </div>
                              </div>
                              <div class="col-md-6 mb-3"> 
                                  <label for="lastName">Tanggal Pembuatan</label>
                                  <input disabled name="tanggalDibuat" type="date" class="form-control" id="lastName" placeholder="" value="{{old('created_on',$purchaseOrder->tanggalDibuat)}}" required="">
                              ...
                              <div class="col-md-6">
                                    ...
                                    <select disabled class="form-control selectpicker" data-live-search="true" data-show-subtext="true" style="width: 100%;" id="perusahaanID" name="perusahaan">
                                      <option value="">
                                            --Pilih Perusahaan--
                                      </option>
                              ...
                              <div class="col-md-6 mb-3">
                                  ...
                                  <input disabled type="date" name="tanggal_akhir" class="form-control" id="lastName" placeholder=""value="{{old('tanggal_akhir',$purchaseOrder->tanggal_akhir)}}" required="">
                                  <div class="invalid-feedback"> Valid last name is required. </div>
                              </div>
                              <div class="col-md-6">
                                    <div class="form-group">
                                   <label for="lastName">Cara Pembayaran</label> 
                                    <select disabled class="form-control selectpicker" data-live-search="true" data-show-subtext="true" style="width: 100%;"name="paymentTerms">
                                      <option value="">
                              ...
                              <div class="col-md-6 mb-3">
                                <div class="form-group">
                                  ...
                                  <select disabled name="supplier" class="form-control selectpicker" data-live-search="true" data-show-subtext="true" style="width: 100%;">
                                      <option value="">
                                          --Pilih Supplier--
                                      </option>
                               ...
                               <div class="col-md-6 mb-3">
                                  ...
                                  <textarea disabled rows="3"  type="text" name="keteranganLokasi" class="form-control" value="{{old('keteranganLokasi',$purchaseOrder->keteranganLokasi)}}" >{{$purchaseOrder->keteranganLokasi}}</textarea>
                              </div>

                              <div class="col-md-6 mb-3">
                                  <label for="lastName">Keterangan Pembayaran</label>
                                  <textarea disabled rows="3"  type="text" name="keteranganPembayaran" class="form-control" value="{{old('keteranganPembayaran',$purchaseOrder->keteranganPembayaran)}}" >{{$purchaseOrder->keteranganPembayaran}}</textarea>
                              </div>

                              <div class="col-md-6 mb-3">
                                  <label for="lastName">Keterangan Penagihan</label>
                                  <textarea disabled rows="3"  type="text" name="keteranganPenagihan" class="form-control" value="{{old('keteranganPenagihan',$purchaseOrder->keteranganPenagihan)}}" >{{$purchaseOrder->keteranganPenagihan}}</textarea>
                              </div>
                                ...
                                <div class="card card-danger">
                                 ...
                                 <div class="form-group"  id='tmbhBarang'>
                                    ...
                                    <div class="form-group" id="harga">
                                        ...
                                        <input disabled type="text" step=".01" id="tanpa-rupiah" class="form-control" value="{{old('harga','')}}" >
                                        <input type="hidden" id="hargaBarang" value = "">
                                    </div>

                                    <div class="form-group"  id='taxDiv'>
                                        <select disabled class="form-control selectpicker" data-live-search="true" data-show-subtext="true" style="width: 100%;"name="tax" id="tax">
                                   ...
                                   <div class="form-group mb-3" id="diskon">
                                      ...
                                      <input disabled type="text" id="tanpa-rupiah-diskon" class="form-control" value="{{old('diskon','')}}" >
                                      <input type="hidden" id="diskonBarang" value=0>
                                  </div>

                                    <div class="form-group " id="ket">
                                        <label disabled for="Keterangan">Keterangan</label>
