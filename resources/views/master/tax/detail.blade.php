...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Pajak -> Detail</h1>
    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('tax.update',[$tax->TaxID])}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input require type="text" name="deskripsi" class="form-control" value="{{old('Deskripsi',$tax->Deskripsi)}}" disabled>
                            </div>

                            <div class="form-group">
                                <label for="title">Persen Pajak</label>
                                <input require type="number" name="taxpercent" class="form-control" value="{{old('TaxPercent',$tax->TaxPercent)}}" disabled>
                            </div>
