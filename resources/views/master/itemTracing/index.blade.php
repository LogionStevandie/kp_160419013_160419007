...
<div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <form action="/itemTracinge/searchname/" method="get">
                    <div class="input-group">
                        <input type="text" class="form-control form-control-lg" name="searchname" placeholder="Nama Tracing">
                             ...
                             <tr>
                                ...
                                <td>  
                                    ...
                                    <div class="modal fade" id="detail_{{$tag->ItemTracingID}}">
                                       ...
                                       <button type="button" class="btn btn-default bg-danger" data-toggle="modal" data-target="#delete_{{$tag->ItemTracingID}}">
                                     <i class="fas fa-trash"></i> 
                                    </button>

                                     <div class="modal fade" id="delete_{{$tag->ItemTracingID}}">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
